...
int main() {
    ...
    if (userInput == "q") {
        cout << "Good job" "!" "Your answer is Correct";
        system("espeak -s 130 'Excellent! Good job! Your answer is correct.'");
    }
    else{
        cout << "Your answer is Incorrect!";
        system("espeak -s 130 ' Your answer is Incorrect!'");
    }
    cout << " Type space:";
    system("espeak -s 130 ' Type space:'");
    getline(cin, userInput);
    if (userInput == "space") {
        cout << "Nice your answer is correct!";
        system("espeak -s 130 ' Nice: Your answer is correct'");
    }
    else {
        system("espeak -s 130 ' Your answer is incorrect'");
    }
